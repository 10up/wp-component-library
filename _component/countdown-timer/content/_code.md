...
{% endhighlight %}
	...
	<p id="standalone-desc" class="c-callout--secondary">
		* <strong>Standalone <abbr title="JavaScript">JS</abbr></strong> is used on projects that are not set up to handle
		...
		JavaScript from the <a href="https://github.com/dkoo/component-countdown-timer/blob/master/dist/countdown-timer.js">component's dist directory</a> and pull it into your
